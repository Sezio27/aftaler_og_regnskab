...
class _NewAppointmentScreenState extends State<NewAppointmentScreen> {
    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
          color: selected ? color : cs.onPrimary,
  ...
  Widget build(BuildContext context) {
    ...
    SliverPadding paddedBox(Widget child) => SliverPadding(
          padding: pagePadding,
    ...
    return SafeArea(
      child: TapRegion(
        ...
        child: CustomScrollView(
          slivers: [
            paddedBox(const SizedBox(height: 20)),
            paddedBox(
              ExpandableSection(
                title: 'Vælg klient',
                child: Column(
            ...
            paddedBox(const SizedBox(height: 30)),
            paddedBox(
              ExpandableSection(
                title: 'Vælg service',
                child: Column(
            ...
            paddedBox(const SizedBox(height: 45)),
            paddedBox(
              _Section(
                title: 'Vælg lokation',
                child: SoftTextField(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          _statusChoice(context, 'Ufaktureret', AppColors.greyMain),
                        ],
                      ),
                    ],
                  ),
            ...
            paddedBox(const SizedBox(height: 40)),
            SliverPadding(
            ...
            SliverPadding(
              padding: EdgeInsets.only(bottom: LayoutMetrics.navBarHeight),
